...
kim2017     = "/media/victor/Datos/Saved/Kim2017/1908151827/Model/model.csv"
...
plotLines('Steer'    ,          'Steer',0.00,0.4)
plotLines('Gas'      ,            'Gas',0.00,0.4)
plotLines('Brake'    ,          'Brake',0.00,0.4)
